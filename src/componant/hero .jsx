...
<>
 <Navbar/>
   <div  className="pb-8 h-[40vh] lg:h-[50vh] bg-cover bg-center  flex flex-col justify-center  " 
        ...
        <h2 className='text-white text-center pb-5 text-shadow-lg/40 text-2xl lg:font-bold  lg:text-4xl '>Millions of movies, TV shows to discover. <br /> Explore <span className= 'text-yellow-500  hover:underline '>now</span> .</h2>
            <Search/> 
